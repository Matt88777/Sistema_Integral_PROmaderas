...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260324054853_IdentityInit'
)
BEGIN
...
BEGIN
    ...
    VALUES (N'20260324054853_IdentityInit', N'8.0.11');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260411151437_IdentityUsuariosExtendido'
)
BEGIN
...
BEGIN
    ALTER TABLE [AspNetUsers] ADD [NombreCompleto] nvarchar(max) NOT NULL DEFAULT N'';
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260411151437_IdentityUsuariosExtendido', N'8.0.11');
END;
GO
