...
{
    private static readonly string[] RolesInternos = ["Gerente", "Contador", "Operador de Planta", "Vendedor"];
    ...
    public async Task<IActionResult> Index()
    {
        ...
        foreach (var usuario in usuarios)
        {
            ...
            var rolInterno = roles.FirstOrDefault(r =>
                r == "Administrador" ||
                r == "Gerente" ||
                r == "Contador" ||
                r == "Operador de Planta" ||
                r == "Vendedor");
    ...
    public async Task<IActionResult> Create(AdminCreateUserViewModel model)
    {
        ...
        {
            ModelState.AddModelError(nameof(model.Rol), "Solo se pueden crear usuarios con un rol interno (Gerente, Contador, Operador de Planta o Vendedor).");
            return View(model);
        }
    ...
    public async Task<IActionResult> ReenviarInvitacion(string email)
    {
        ...
        {
            TempData["Error"] = "Solo se pueden reenviar invitaciones a usuarios internos (Gerente, Contador, Operador de Planta o Vendedor).";
            return RedirectToAction(nameof(Index));
        }
